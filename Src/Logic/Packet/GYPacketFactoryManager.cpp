...
static GYPacketFactoryManager* pSingletion = GYNULL;
GYPacketFactoryManager::GYPacketFactoryManager()
{
...
GYPacketFactoryManager& GYPacketFactoryManager::GetSingleton()
{
	return *pSingletion;
}
